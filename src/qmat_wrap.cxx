...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__qmat

#else
#  define SWIG_init    init_qmat

#endif
#define SWIG_name    "_qmat"
...
SWIGINTERN PyObject *_wrap_p_inf(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  double *arg1 = (double *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:p_inf",&obj0)) SWIG_fail;
  {
  ...
  result = (PyObject *)p_inf(arg1,arg2,arg3);
  resultobj = result;
  {
...
SWIGINTERN PyObject *_wrap_mat_solve(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  double *arg1 = (double *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:mat_solve",&obj0)) SWIG_fail;
  {
    array1 = obj_to_array_contiguous_allow_conversion(obj0, NPY_DOUBLE, &is_new_object1);
    npy_intp size[2] = {
      -1, -1 
  ...
  result = (PyObject *)mat_solve(arg1,arg2,arg3);
  resultobj = result;
  {
    if (is_new_object1 && array1)
    {
...
SWIGINTERN PyObject *_wrap_p(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:p",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  arg1 = obj0;
  arg2 = obj1;
  arg3 = obj2;
  arg4 = obj3;
  arg5 = obj4;
  result = (PyObject *)p(arg1,arg2,arg3,arg4,arg5);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"init_matrix", _wrap_init_matrix, METH_VARARGS, (char *)"\n"
		"init_matrix(inout_arr)\n"
		"\n"
		"Initializes the diagonal elements of Q in-place,\n"
		...
		"\n"
		"Returns:\n"
		"Q will be updated in-place.\n"
		""},
	 { (char *)"p_inf", _wrap_p_inf, METH_VARARGS, (char *)"\n"
		"p_inf(in_arr) -> PyObject\n"
		"\n"
		"Calculates p_inf for a Q matrix.\n"
		"Ch. 20, Eq. 16, 17\n"
		"      \n"
		"Arguments:\n"
		...
		"\n"
		"Returns:\n"
		"p_inf as a numpy array.\n"
		""},
	 { (char *)"mat_solve", _wrap_mat_solve, METH_VARARGS, (char *)"\n"
		"mat_solve(in_arr) -> PyObject\n"
		"\n"
		"Calculates the spectral matrices according to\n"
		"Ch. 20, Eq. 88, 89\n"
		"      \n"
		"Arguments:\n"
		"in_arr -- The initialized Q matrix.\n"
		...
		"(lambda, A) as a tuple.\n"
		""},
	 { (char *)"p", _wrap_p, METH_VARARGS, (char *)"\n"
		"p(t, p_0, p_inf, lambda_r, A) -> PyObject\n"
		"\n"
